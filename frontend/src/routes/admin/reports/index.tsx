...
function ReportsPage() {
  ...
  const downloadExcelReport = async () => {
    ...
    try {
      const response = await fetch(
        `${API_URL}${api.admin.base}/${api.admin.reports}/sales/excel`,
        {
          method: "POST",
          headers: {
  ...
  const getStatusBadge = (status: InventoryStatus) => {
    const badges: Record<InventoryStatus, string> = {
      in_stock:
    ...
    return (
      <span
        className={`px-2 py-1 rounded text-xs font-semibold ${badges[status]}`}
      >
        {labels[status]}
      </span>
    );
          ...
          <Card>
            ...
            <CardContent className="flex flex-wrap gap-4">
              ...
              <div className="flex items-end gap-2">
                ...
                >
                  <Download
                    className={`size-4 mr-2 ${isDownloading ? "animate-spin" : ""}`}
                  />
                  Excel
                </Button>
              </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {formatPrice(salesData.total_sales)}
                    </div>
                  </CardContent>
                </Card>
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {formatPrice(inventoryData.total_value)}
                    </div>
                  </CardContent>
                </Card>
              </div>
